...
export default function ShareModal({ isOpen, onClose, title, content, className = "" }: ShareModalProps) {
  ...
  return (
    <div className={`fixed inset-0 flex items-end justify-center ${className}`}>
