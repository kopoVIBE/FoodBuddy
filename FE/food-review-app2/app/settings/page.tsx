      ...
      <div className="max-w-md mx-auto px-4 py-6 space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className={`font-medium ${isDarkMode ? "text-white" : ""}`}>푸드러버</h3>
                <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>foodlover@example.com</p>
              </div>
              <Button
                variant="outline"
                size="sm"
        ...
        <Card className={isDarkMode ? "bg-gray-800 border-gray-700" : ""}>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label className={isDarkMode ? "text-white" : ""}>서비스 푸시 알림</Label>
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className={isDarkMode ? "text-white" : ""}>리뷰 리마인더</Label>
                <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>
                  방문한 음식점 리뷰 작성 알림
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className={isDarkMode ? "text-white" : ""}>추천 알림</Label>
                <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>맞춤 음식점 추천 알림</p>
              </div>
        ...
        <Card className={isDarkMode ? "bg-gray-800 border-gray-700" : ""}>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label className={isDarkMode ? "text-white" : ""}>다크 모드</Label>
                <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>어두운 테마 사용</p>
              </div>
            ...
            <div>
              ...
              <Select value={language} onValueChange={setLanguage}>
                ...
                <SelectContent className={isDarkMode ? "bg-gray-700 border-gray-600" : ""}>
                  <SelectItem value="ko" className={isDarkMode ? "text-white hover:bg-gray-600" : ""}>
                    한국어
                  </SelectItem>
                  <SelectItem value="en" className={isDarkMode ? "text-white hover:bg-gray-600" : ""}>
                    English
                  </SelectItem>
                </SelectContent>
              </Select>
