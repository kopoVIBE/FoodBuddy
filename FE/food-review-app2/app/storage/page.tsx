    ...
    <div className={`min-h-screen pb-20 ${isDarkMode ? "bg-gray-900" : "bg-gray-50"}`}>
      ...
      >
        <div className="max-w-md mx-auto px-4 py-4">
          <h1 className={`text-xl font-bold text-center ${isDarkMode ? "text-white" : "text-gray-900"}`}>저장소</h1>
        </div>
      </div>
              ...
              {savedReviews.map((review) => (
                <Card
                  ...
                  className={`cursor-pointer hover:shadow-md transition-shadow ${
                    isDarkMode ? "bg-gray-800 border-gray-700 hover:bg-gray-750" : "bg-white hover:shadow-lg"
                  }`}
                  ...
                  <CardContent className="p-4">
                    <div className="flex gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-1">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            >
                              <Heart
                                className={`h-4 w-4 ${
                                  review.isFavorite ? "fill-orange-500 text-orange-500" : "text-gray-400"
                                }`}
                              />
                            </Button>
                            <Button
                        ...
                        <div
                          className={`flex items-center gap-1 text-xs mb-2 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}
                        >
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {review.tags.map((tag) => (
                        <Badge
                          ...
                          variant="outline"
                          className={`text-xs ${
                            isDarkMode ? "border-gray-600 text-gray-300 bg-gray-700" : "border-gray-300 text-gray-600"
                          }`}
                        >
                          {tag}
                        </Badge>
          ...
          <TabsContent value="favorites" className="space-y-4">
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex gap-3">
                      ...
                      >
                        <span className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>이미지</span>
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-1">
                          ...
                          <Button size="sm" variant="ghost" className="p-1 hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            {favoriteRestaurants.length === 0 && (
              <div className="text-center py-12">
                <Heart className={`h-12 w-12 mx-auto mb-4 ${isDarkMode ? "text-gray-600" : "text-gray-400"}`} />
