    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className={`border-orange-200 ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white"}`}>
          <CardContent className="p-4 text-center">
            ...
            <div
              className={`text-sm flex items-center justify-center gap-1 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
            >
      ...
      <Card className={`border-orange-200 ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white"}`}>
        <CardHeader className="pb-3">
          <CardTitle
            className={`text-lg flex items-center gap-2 text-orange-700 ${isDarkMode ? "text-orange-400" : ""}`}
          >
          ...
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={monthlyStats}>
                ...
                <XAxis dataKey="month" tick={{ fontSize: 12, fill: isDarkMode ? "#d1d5db" : "#6b7280" }} />
                <YAxis tick={{ fontSize: 12, fill: isDarkMode ? "#d1d5db" : "#6b7280" }} />
                <Line
                  type="monotone"
                  dataKey="reviews"
                  stroke="#ea580c"
          ...
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={ratingDistribution}>
                <CartesianGrid strokeDasharray="3 3" stroke={isDarkMode ? "#374151" : "#f3f4f6"} />
                <XAxis dataKey="rating" tick={{ fontSize: 12, fill: isDarkMode ? "#d1d5db" : "#6b7280" }} />
                <YAxis tick={{ fontSize: 12, fill: isDarkMode ? "#d1d5db" : "#6b7280" }} />
